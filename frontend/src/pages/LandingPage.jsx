...
export default function LandingPage() {
  return (
    <div className="text-center">
      <section className="rounded-3xl bg-gradient-to-br from-indigo-500 via-fuchsia-500 to-teal-400 text-white p-10 shadow-md">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <NavLink to="/auth"><Button variant="primary" className="bg-white text-slate-900 hover:bg-white/90">Get Started</Button></NavLink>
      ...
      <section className="grid md:grid-cols-3 gap-6 mt-8">
        {[
          ...
          <div key={f.title} className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 text-left shadow-sm hover:shadow-md transition">
