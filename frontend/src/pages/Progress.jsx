    ...
    <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="flex items-end gap-2 h-40">
            {progressData.xpHistory.map((v, i) => (
              <div key={i} className="flex-1">
                <div className="rounded-t-xl bg-gradient-to-t from-secondary-500 via-info-500 to-success-500" style={{ height: `${(v/520)*100}%` }} />
                <div className="text-xs text-center mt-1 text-grey-500">D{i+1}</div>
              </div>
            ))}
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-grey-500">Keep it going!</p>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-3">
          {progressData.accuracyBySubject.map((s)=> (
            <div key={s.subject}>
              ...
              <div className="h-2 bg-grey-200 dark:bg-grey-800 rounded-full overflow-hidden"><div className="h-full bg-primary-500" style={{width: `${s.accuracy}%`}} /></div>
            </div>
          ))}
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="list-disc pl-5 text-sm space-y-2 text-grey-600 dark:text-grey-300">
